...
namespace NumberGuessWorkflowActivities {
    ...
    public partial class ReadInt : System.Activities.Activity, System.ComponentModel.ISupportInitialize {
...
partial void AfterInitializeComponent();
        ...
        public void InitializeComponent() {
            ...
            System.IO.Stream initializeXaml = typeof(ReadInt).Assembly.GetManifestResourceStream(resourceName);
            ...
            try {
                ...
                writerSettings.AccessLevel = System.Xaml.Permissions.XamlAccessLevel.PrivateAccessTo(typeof(ReadInt));
        ...
        private string FindResource() {
            string[] resources = typeof(ReadInt).Assembly.GetManifestResourceNames();
            for (int i = 0; (i < resources.Length); i = (i + 1)) {
                string resource = resources[i];
                if ((resource.Contains(".ReadInt.g.xaml") || resource.Equals("ReadInt.g.xaml"))) {
                    return resource;
                }
            }
